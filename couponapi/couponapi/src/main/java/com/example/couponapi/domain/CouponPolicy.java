...
public class CouponPolicy extends BaseEntity {
    ...
    public CouponPolicy(SaveCouponPolicyServiceParam serviceParam) {
        code = serviceParam.getCode();
        type = serviceParam.getType();
        amount = serviceParam.getAmount();
        discountType = serviceParam.getDiscountType();
        totalQuantity = serviceParam.getTotalQuantity();
        startAt = serviceParam.getStartAt();
        expiredAt = serviceParam.getExpiredAt();
        minOrderAmount = serviceParam.getMinOrderAmount();
        maxDiscountAmount = serviceParam.getMaxDiscountAmount();
    }
